    ...
    button.addEventListener("click", function(event) {
      ...
      if (clickX < buttonWidth / 2) {
        ...
        setTimeout(function() {
          ...
          popupLeft.querySelector(".popup-text").textContent = "Error: Este usuario no te envío regalo!";
        }, 4543); // 4543ms = 4,543s
      } else {
        ...
        setTimeout(function() {
          ...
          popupRight.querySelector(".popup-text").textContent = "Validación exitosa: Este usuario te envío regalo!";
        }, 1212); // 1212ms = 1,212s
      }
    });
